class PurchaseAddress
  ...
  def save
    ...
    Address.create(zip: zip, ship_region_id: ship_region_id, ship_city: ship_city, ship_address: ship_address,
                   ship_building: ship_building, phone: phone, purchase_id: purchase.id)
  end
end
